...
public class ServletUtils {
	...
	private final static String PROJECT_FILES = PROJECT_NAME + "/inputFiles";
	...
	public static String getDetailLinkTargetString() {
		return LOCAL_HOST + PROJECT_NAME + "/" + MOVIE_DETAIL_SERVLET + "?film_id=";
	}
	...
	/**
	 * This method must be called by the "home" servlet (the first one loaded) to
	 * set up the file paths for this application. File paths will differ
	 * depending on where the server is running, so to find the location of data
	 * files, need to determine the absolute path for this application
	 * 
	 * @param config
	 *          the configuration for the "home" servlet
	 */
	public static void setAbsolutePath(ServletConfig config) {
		...
		int pluginLocation = realPathWebInf.indexOf(".") + 13;
